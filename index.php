...
<html lang="en">
  ...
  <head>
    ...
    <title>Scholar - SEUN Online School </title>
...
<body>
      ...
      <div class="row">
        <div class="col-lg-7">
          <div class="owl-carousel owl-testimonials">
            <div class="item">
              <p>“Please tell your friends or collegues about Seun's online lesson. Anyone can access the website to download free templates. Thank you for visiting.”</p>
              <div class="author">
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="contact-us-content">
            <form id="contact-form" action="includes/formhandler.inc.php" method="post">
              <div class="row">
                <div class="col-lg-12">
                  <fieldset>
  ...
  <footer>
    <div class="container">
      <div class="col-lg-12">
        <p>Copyright © 2036 Scholar Organization. All rights reserved. &nbsp;&nbsp;&nbsp; Design: <a href="https://templatemo.com" rel="nofollow" target="_blank">SeunMo</a></p>
      </div>
    </div>
  </footer>
